package com.dharmesh.testUtills;
...
public class Utills {
	...
	public static WebDriver selectBrowser(String browser){
		if (browser.equals("firefox") || browser.equals("FIREFOX")) {
			...
			System.setProperty("webdriver.chrome.driver",System.getProperty("user.dir")+ "\\src\\com\\dharmesh\\browserDrivers\\chromedriver.exe");
